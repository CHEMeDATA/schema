	...
	const htmlContent = `
        ...
        <head>
            ...
            <style>
                ...
                .blue-frame { background-color: #cce5ff; border: 1px solid #007bff; width: 98%;  margin: 0;box-sizing: border-box;max-width: 800px;}
                .red-frame { background-color: #f8d7da; border: 1px solid #dc3545; width: 98%;  margin: 0;box-sizing: border-box;max-width: 800px;}
                .green-frame { background-color: #d4edda; border: 1px solid #28a745; width: 98%;  margin: 0;box-sizing: border-box;max-width: 800px;}
                .orange-frame { background-color: #d4edda; border: 1px solid #be9131ff; width: 98%;  margin: 0;box-sizing: border-box;max-width: 800px;}
                #returnButton { display: inline-block; padding: 10px 15px; background-color: #214162ff; 
