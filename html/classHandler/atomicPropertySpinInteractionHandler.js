...
export class AtomicPropertySpinInteractionHandler {
	constructor(obj = {}) {
		this.obj = obj;
		this.verbose = true;
		this.verboseStartingString = "AtomicPropertySpinInteractionHandler";
	}
...
// Auto-generated supplement file for atomicPropertySpinInteraction
atomicPropertySpinInteraction_DataEnrichment(targetObjType, dataObj = {}) {
    const myName = "atomicPropertySpinInteraction_DataEnrichment"; // don't automatize in case 'use strict'
    const myName2 = "atomicPropertySpinInteraction_DataEnrichment"; // don't automatize in case 'use strict'
    if (targetObjType == "info") {
        return {
            sourceObjType: "atomicPropertySpinInteraction",
            targetObjType: "atomicPropertySpinInteractionMatch",
...
//module.exports = atomicPropertySpinInteraction_DataEnrichment;
